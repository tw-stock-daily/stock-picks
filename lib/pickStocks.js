...
function scoreStock(bars) {
  ...
  /* ===== 主流科技加權 ===== */
  const techBoost = hasAny(this?.stockTags || [], CORE_TECH_TAGS); // 不使用，保留相容
  void techBoost;
